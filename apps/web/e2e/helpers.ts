...
/**
 * How a stored number is rendered in tables: "03413275" -> "03 413 275".
 * Names repeat across runs; a number generated by uniquePhone() does not, so
 * locators that must survive a re-run against a warm database key on this.
 */
